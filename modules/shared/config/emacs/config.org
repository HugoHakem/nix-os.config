...
#+BEGIN_SRC emacs-lisp
  (setq user-full-name "Hugo"
    user-mail-address "hhakem@broadinstitute.org")
#+END_SRC
...
#+BEGIN_SRC emacs-lisp
  ...
  ;; Set path for darwin
  (when (system-is-mac)
    (setenv "PATH" (concat (getenv "PATH") ":/Users/hhakem/.nix-profile/bin:/usr/bin"))
    (setq exec-path (append '("/Users/hhakem/bin" "/profile/bin" "/Users/hhakem/.npm-packages/bin" "/Users/hhakem/.nix-profile/bin" "/nix/var/nix/profiles/default/bin" "/usr/local/bin" "/usr/bin") exec-path)))
#+END_SRC
